...
## Todo
  - Implement support for custrom name property in Table annotation (table name in createTable, CRUD methods etc)
  - Add support for a custom query select statement by returning a List of HashMap(s) of resulting columns (Done)
